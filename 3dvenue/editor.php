        ...
        <div id="addPage">
            ...
            <div id="pageview">
                ...
                <div id="pageaddbutton">
                    <form method="post">
                        <input type="hidden" name="cid" id="tempid" value="">        
...
//parts add
    ...
    $('#addsection section div.parts').on('click', function(){
    ...
    $('#addParts section div.parts').on('click', function(){
        const cid = $(this).data('cid');
        let place = $('#addParts .addparts:checked').val();
        const data = allParts.find(p => p.cid == cid);
        const $parts = $('main .active');
            if(place == "before"){
                $parts.before(data.dom);
            }
            if(place == "after"){
                $parts.after(data.dom);
            }        
        $('#parts').removeClass();
        setDataTag();
    });
