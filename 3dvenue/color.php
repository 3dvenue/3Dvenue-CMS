...
if(isset($_POST['css'])){
    ...
    if ($submit === "saveAdmin") {
        file_put_contents('./common/layout/color.css', $css);
    }
...
$stylesheet = file_get_contents('../common/layout/color.css');
...
<head>
    ...
    #checkedheart:checked + label span{
        color:red;
    }
    ...
    #main #colors{
        ...
        border-radius: 3px;
        background:#1A243477;
        box-shadow: 2px 2px 5px #0001 inset;
    }
    ...
    #colors.heart ul li[data-heart="0"]{
        display: none;
    }

    #colors ul li.select{
        outline: 4px dashed #000c;
        outline-offset: -4px;
    }

    #colors ul li:hover{
        outline:2px solid #8046C8;
    }
    ...
    #colors ul li label input:checked + span{
        color:red;
    }

    #colors ul li label input{
        display: none;
    }
    ...
    #coloreditor #form label{
        display: flex;
        align-items: center;
        gap:10px;
    }

    #coloreditor #form input[type="text"]{
        padding:3px 10px;
        border-radius: 5px;
        border:1px solid #ccc;
        width:8em;
    ...
    #coloreditor #form #btn{
        display: flex;
        justify-content: space-between;
        align-items: center;
    }

    #coloreditor #form #delete{
        background:none;
        padding: 0 0px;
    }

    #coloreditor #form label div{
        text-align: center;
        background:#FFF;
        color:#333;
    ...
    #coloreditor #form #file{
        display: none;
    }


    #coloreditor  #form input[type="color"]{
        padding:0 2px;
        border-radius:0;
        border:none;
        border:1px solid #CCC;
    ...
    #main #mapping #mapping_panel .close{
        right:-30px;
    }

    #main #mapping #mapping_panel #setcolor{
        position: relative;
        height:100%;
    ...
    #main #mapping #mapping_panel #setcolor .colorbar{
        height:25%;
        width:80px;
        font-size:12px;
        color:#FFF;
    ...
    #main #mapping #mapping_panel #setcolor #paletchange{
        position: absolute;
        top:0;
        right:0;
        width:30px;
    ...
    #main #mapping #mapping_panel #setcolor #paletchange div{
        width:100%;
        height:50%;
        display: flex;
        align-items: center;
    ...
    #main #mapping #mapping_panel #setcolor #paletchange div:hover{
        color:#5390F1;
    }

    #main #mapping #mapping_panel label{
        line-height: 1.2;
        white-space: pre-line;
    }

    #main #mapping #mapping_panel input[type="radio"]{
        accent-color: green;
    }

    #main #mapping #mapping_panel input[type="color"]{
        width:30px;
    }

    #main #mapping #mapping_panel input[type="text"]{
        width:60px;
        padding:1px 3px;
        font-size:12px;
        line-height:1.0;
    ...
    #main #mapping #mapping_panel label span{
        margin:0 10px;
        font-size:12px;
    }

    #main.mapping #mapping #startmapping{
        display: none;
    }

    #main.mapping #mapping #mapping_panel{
        display:flex;
    }
    ...
    #body section.eyecatch{
        padding:80px 0 80px;
        background-image:url(./lib/mapping.webp);
    ...
    main section .text.radius p{
        text-align: left;
        font-size:17px;
    }

    #body section.eyecatch h1{
        color:#FFF;text-shadow:3px 3px 10px #0003;
    }
...
<div id="main">
<div class="inner">
    <h2><?=$lang['color_edit'][$lng]?> <button id="direct" class="btn">Direct Edit</button> <div id="new">＋</div></h2>
...
$(function() {
    ...
    $('#direct').on('click',function(){
        ...
        $.get('../common/layout/color.css?t=<?=time()?>', function(data){
